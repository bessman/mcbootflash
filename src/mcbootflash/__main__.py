...
def main(args: None | argparse.Namespace = None) -> None:
    ...
    try:
        ...
        boot_attrs = mcbf.get_boot_attrs(connection)
        total_bytes, chunks = mcbf.chunked(args.hexfile, boot_attrs)
        _logger.info("Erasing program area...")
        mcbf.erase_flash(connection, boot_attrs.memory_range, boot_attrs.erase_size)
